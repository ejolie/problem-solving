...
public class Day6 {
    ...
    public static int findKthPositive_binarySearch(int[] arr, int k) {
        ...
        while (l < r) {
            int mid = l + (r - l) / 2;
            if (arr[mid] - (mid + 1) >= k) {
                // k개 이상의 숫자가 없음, go left
                r = mid;
            } else {
                // k개 미만의 숫자가 없음, go right
                l = mid + 1;
            }
        }
